...
self.addEventListener("fetch", function (event) {
  var url = "https://pwagram-bf1ef-default-rtdb.firebaseio.com/posts";
          ...
          fetch(
            "https://us-central1-pwagram-bf1ef.cloudfunctions.net/storePostData",
            {
              ...
              body: JSON.stringify({
                ...
                image:
                  "https://firebasestorage.googleapis.com/v0/b/pwagram-bf1ef.appspot.com/o/sf-boat.jpg?alt=media&token=76857877-a737-42b4-a0ba-6d3b94afea95",
              }),
            }
          )
            .then(function (res) {
...
self.addEventListener("notificationclick", function (event) {
  ...
  if (action === "confirm") {
    ...
    event.waitUntil(
      // We can execute clients and this basically refers to all windows or all browser tasks related to this service worker.
